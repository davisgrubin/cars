...
b) There is another linear transformation that also rescales the scores to have mean 100 and std. deviation 15. What is it, and why would you *not* want to use it for this purpose?
...
paste(c("was 30 before transformation: after transformation is"), c(should_be_lower))
paste(c("was 35 before transformation: after transformation is"),c(should_be_higher))
```
